...
export const imagePrompt = (assessment: string):string =>{
    ...
    return assistantPrompt+". The assessment of another multimodal AI model on the provided picture is included here \"\"\""+assessment+"\"\"\""+
    "After doing you own analysis, take into account the other LLM's assessment to provide a final result. If the other assessment does not have a high degree of certainty or does not agree with your analysis,"
    + "have more confidence your analysis.\n"+
    assistantPrompt;
}

const assistantPrompt = "You are an expert in analysing images and understanding whether they have been generated or modified by Artifial intelligence methods and tools."+
